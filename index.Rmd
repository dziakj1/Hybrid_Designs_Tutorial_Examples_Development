...
Again, we need to fit separate models for the distal and the proximal outcome.
...
The output suggests answers to the two questions of interest. 
...
This page provides links to simulated datasets and sample analysis code and output for three novel kinds of experimental designs for use in informing the development of [multimodal adaptive interventions](https://d3c.isr.umich.edu/integration/#madi).
